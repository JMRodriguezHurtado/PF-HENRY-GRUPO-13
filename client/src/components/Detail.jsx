      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        <div className="flex flex-col md:flex-row -mx-4">
          ...
          <div className="md:flex-1 px-4">
            ...
            <p className="text-gray-900 mt-5">Max Quantity: {productById.quantity}</p>

            <p className="text-gray-900">Category: {productById.category}</p>
            ...
            <div className="flex py-4 space-x-4 items-center"> 
              <div className="relative">
                ...
                <select
                  ...
                  className="cursor-pointer appearance-none rounded-xl border border-gray-200 pl-4 pr-8 h-14 flex items-end  pl-10 py-5"
                >
