      ...
      <div className="container mx-auto mt-70 px-6 py-10 sm:-mt-80 md:-mt-96">
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-3">
          <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
              <img className="aspect-square w-full rounded-xl object-cover" src="https://media.licdn.com/dms/image/D4E35AQFVGGMFeYgqUQ/profile-framedphoto-shrink_800_800/0/1694551964509?e=1702357200&v=beta&t=MLOZvQPer7N37RYFSBgHt3sozoDNO-4DOPv-zPmdetw" alt="" />
              ...
              <div className="-mx-2 mt-3 flex">
                <a href="https://www.linkedin.com/in/wsmith123/" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Facebook" rel="noreferrer">
                  <FaLinkedin className='text-4xl'/>
                </a>

                <a href="https://github.com/JavonMagistral" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Github" rel="noreferrer">
            ...
            <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                ...
                <div className="-mx-2 mt-3 flex">
                  <a href="https://www.linkedin.com/in/elias-martinez-040980246/" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Facebook" rel="noreferrer">
                    <FaLinkedin className='text-4xl'/>
                  </a>

                  <a href="https://github.com/XliazZz" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Github" rel="noreferrer">
                    <FaGithub className='text-4xl'/>
                  </a>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                ...
                <div className="-mx-2 mt-3 flex">
                  <a href="https://www.linkedin.com/in/juan-manuel-rodriguez-hurtado-87b531164/" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Facebook" rel="noreferrer">
                    <FaLinkedin className='text-4xl'/>
                  </a>

                  <a href="https://github.com/JMRodriguezHurtado" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Github" rel="noreferrer">
                    <FaGithub className='text-4xl'/>
                  </a>
                </div>
            </div>
